...
echo ""
echo "######################################################"
echo "#           Setup Fairyring KeyShare Module          #"
echo "######################################################"
echo ""
...
./keyshareSender.sh $BINARY $CHAIN_DIR/$CHAINID_1 tcp://localhost:16657 $VALIDATOR_1 $CHAINID_1 $GENERATOR $GENERATED_SHARE > $CHAIN_DIR/keyshareSender.log 2>&1 &
...
echo ""
echo "######################################################"
echo "#    SUCCESSFULLY SETUP Fairyring KeyShare Module    #"
echo "######################################################"
echo ""